...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"显示 _MENU_ 个订单",sZeroRecords:"抱歉，没找到~~",sEmptyTable:"No data available in table",
sLoadingRecords:"Loading...",sInfo:"订单： _START_ 至 _END_ 共 _TOTAL_ 个",sInfoEmpty:"订单： 0 至 0 共 0 个",sInfoFiltered:"(通过 _MAX_ 个订单)",sInfoPostFix:"",sInfoThousands:",",sSearch:"搜索:",sUrl:"",oPaginate:{sFirst:"首页",sPrevious:"上一页",sNext:"下一页",sLast:"末页"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
